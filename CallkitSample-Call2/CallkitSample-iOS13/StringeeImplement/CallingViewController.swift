...
class CallingViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        self.btVideo.isHidden = !self.callControl.isVideo
        self.lbVideo.isHidden = !self.callControl.isVideo
...
extension CallingViewController: StringeeCall2Delegate {
    func didChangeSignalingState2(_ stringeeCall: StringeeCall2!, signalingState: SignalingState, reason: String!, sipCode: Int32, sipReason: String!) {
    ...
    func didChangeMediaState2(_ stringeeCall: StringeeCall2!, mediaState: MediaState) {
        ...
        DispatchQueue.main.async {
            switch mediaState {
            case .connected:
                self.shouldCheckDisplayingOptions = true
